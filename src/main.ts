...
const letter1 = document.querySelector<HTMLInputElement>('#first-1')
const letter2 = document.querySelector<HTMLInputElement>('#first-2')
const letter3 = document.querySelector<HTMLInputElement>('#first-3')
const letter4 = document.querySelector<HTMLInputElement>('#first-4')
const letter5 = document.querySelector<HTMLInputElement>('#first-5')
